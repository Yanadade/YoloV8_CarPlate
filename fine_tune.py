...
class CFG:
    ...
    #paths
    out_folder = f'NEURAL NETWORKS AND DEEP LEARNING/Custom/new working_finetuning'
...
def plot_random_images_from_folder(folder_path, num_images=20, seed=CFG.seed):
    ...
    for i, file_name in enumerate(selected_files):
        ...
        xmin, xmax, ymin, ymax = get_bbox(file_path=os.path.join('NEURAL NETWORKS AND DEEP LEARNING/Custom/Car License Plate Detection/annotations',
...
anoattions_path_xml = glob.glob('NEURAL NETWORKS AND DEEP LEARNING/Custom/Car License Plate Detection/annotations/*.xml')

image_paths = glob.glob('NEURAL NETWORKS AND DEEP LEARNING/Custom/Car License Plate Detection/images/*.png')
...
plot_random_images_from_folder(folder_path= 'NEURAL NETWORKS AND DEEP LEARNING/Custom/new working_finetuning/train/images',
                               num_images=20,
                               seed=CFG.seed)
...
res_path = 'NEURAL NETWORKS AND DEEP LEARNING/Custom/new working_finetuning/runs/detect/car_plate_detection'
...
tpaths2=[]
for dirname, _, filenames in os.walk('NEURAL NETWORKS AND DEEP LEARNING/Custom/new working_finetuning/runs/detect/car_plate_detection'):
...
test_images = glob.glob('NEURAL NETWORKS AND DEEP LEARNING/Custom/Automatic Number Plate Recognition/images/*.jpeg')
...
df_frame, out_image  = run_pipeline(path = test_images[12], display=True)
...
df = pd.read_csv('NEURAL NETWORKS AND DEEP LEARNING/Custom/new working_finetuning/runs/detect/car_plate_detection/results.csv')
...
model = YOLO('NEURAL NETWORKS AND DEEP LEARNING/Custom/new working_finetuning/runs/detect/car_plate_detection/weights/best.pt')
